...
Answer:
Compiler’s job is to translate high level programming code into lower level langaunge.
...
It's an interactive mode that allows users to enter and execute commands one at a time.

_________________________________________________________________________
Is it true that Python development always has to take place using interactive-mode within the Python interpreter?
Answer:
No, Python development does not necessarily have to take place within the Python interpreter in interactive mode.
...
Answer:
They use it for code reusability, time efficiency, access to specialized features ,quality and reliability and many more.
...
Answer:
multiply_num=20.25*100*23.9
Print (multiply_num)
# the result is 48,397.5
